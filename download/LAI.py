...
Date: 2025-04-09 23:54:18
LastEditors: cunyu277 2465899266@qq.com
LastEditTime: 2025-04-11 00:18:39
FilePath: \crop_yield_prediction\cunuu\download\LAI.py
Description: lai download
...
for year in range(2010, 2023):
    ...
    def process_image(img):
        ...
        lai = img.select('Lai_500m').rename(ee.String('LAI_').cat(date_str))
        return lai
